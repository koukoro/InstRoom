...
.product-page__meta { display: flex; flex-direction: column; gap: 6px; }
.product-page__meta-item { font-size: var(--fs-mini); color: var(--color-dark); }
.product-page__meta-label { color: var(--color-gray); }

.product-page__price-row { display: flex; align-items: baseline; gap: 12px; }
.product-page__price {
  font-family: var(--font-heading);
  font-size: var(--fs-h1);
  line-height: 1;
...
.product-page__stock--out { color: var(--color-gray); }

.product-page__actions { display: flex; align-items: center; gap: 12px; }
...
.product-page__fav-btn--active { border-color: var(--color-primary); color: var(--color-primary); }

.product-page__description { padding-top: 20px; border-top: 1px solid var(--color-light); }
