    ...
    <RouterLink :to="`/product/${product.slug}`" class="product-card__img-link">
      <div class="product-card__img-wrap">
        ...
        <div class="product-card__actions">
          <button class="product-card__action-btn" title="Сравнить">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
              <line x1="18" y1="20" x2="18" y2="10"/><line x1="12" y1="20" x2="12" y2="4"/><line x1="6" y1="20" x2="6" y2="14"/>
            </svg>
          </button>
          <button class="product-card__action-btn" :class="{ 'product-card__action-btn--active': liked }" @click.prevent="liked = !liked" title="В избранное">
        ...
        <img
            ...
            @error="imgError = true"
        />
        <div v-else class="product-card__img product-card__img--placeholder img-placeholder">
    ...
    <div class="product-card__body">
      ...
      <div class="product-card__footer">
        <div class="product-card__prices">
          ...
          <span v-if="product.inStock" class="product-card__stock">
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="var(--color-primary)" stroke-width="2.5"><polyline points="20 6 9 17 4 12"/></svg>
            в наличии
          </span>
          <span v-else class="product-card__stock product-card__stock--out">под заказ</span>
        </div>
        <button
...
.product-card__action-btn--active { color: var(--color-primary); }
.product-card__img {
  width: 100%;
  max-height: 180px;
  object-fit: contain;
...
.product-card__stock--out { color: var(--color-gray); }
