    ...
    <nav class="header__nav">
      <div class="container header__nav-inner">
        ...
        <button class="header__catalog-btn" @click="toggleMenu">
          <img src="@/assets/images/sticks.png" alt="Структура"/>
          Каталог товаров
        </button>
        ...
        <div class="header__socials">
          <a href="#" class="header__social">
            <img src="@/assets/images/instagram.png" alt="Инстаграм" />
          </a>
          <a href="#" class="header__social">
            <img src="@/assets/images/vkontakte.png" alt="Вконтакте" />
          </a>
          <a href="#" class="header__social">
            ...
            <ul v-else>
              ...
              >
                <div class="search-dropdown__img img-placeholder">
                  <img src="@/assets/images/emal.png" alt="Эмаль">
                </div>
...
.header__action:hover { background-color: var(--color-primary); }
...
.search-dropdown__name { flex: 1; font-size: var(--fs-mini); color: var(--color-dark); }
...
.mega-menu__sub-col li + li { margin-top: 10px; }
