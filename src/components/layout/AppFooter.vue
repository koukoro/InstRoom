...
.footer__phones a { font-size: var(--fs-mini); color: var(--color-light); }
.footer__socials { display: flex; gap: 8px; }
.footer__social { color: var(--color-light); transition: color 0.2s; }
.footer__social:hover { color: var(--color-primary); }
.footer__copy { font-size: var(--fs-shape); color: var(--color-gray); line-height: 1.6; }
</style>